...
- Fork change: fail startup when auth is enabled but the password is empty or still `changeme`.
- Fork change: remove upstream prebuilt image reference so HAOS can build this fork locally.
